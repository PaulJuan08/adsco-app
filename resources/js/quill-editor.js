 ...
 * Quill v2 wraps all list items in <ol> and uses data-list="bullet"|"ordered" on each <li>.
 * This converts them into native <ul> (bullets) and <ol> (numbers).
 */
    ...
    root.querySelectorAll('.rich-text').forEach(function(el) {
        el.querySelectorAll('ol').forEach(function(ol) {
            ...
            items.forEach(function(li) {
                ...
                // Remove empty Quill UI marker spans
