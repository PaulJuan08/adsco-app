        ...
        <div class="card-body">
            ...
            <div class="two-column-layout">
                    ...
                    <form action="{{ isset($topic) ? route('teacher.topics.update', Crypt::encrypt($topic->id)) : route('teacher.topics.store') }}" method="POST" enctype="multipart/form-data" id="topicForm">
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-group">
                                ...
                                <!-- Show current PDF if exists (for edit mode) -->
                ...
                <div class="sidebar-column">
                        ...
                        <div class="tips-grid">
                            ...
                            <div class="tip-item">
                                ...
                                <div class="tip-content">
                                    ...
                                    <div class="tip-description">After creating, assign topic to your courses</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <!-- Topic Summary Card (for Edit mode only) -->
                    @if(isset($topic))
                    <div class="sidebar-card">
                        <div class="sidebar-card-title">
                        ...
                        <div class="summary-stats">
                            ...
                            <div class="summary-row">
                                ...
                                <span class="summary-value">{{ $resources }} file(s)</span>
                            </div>
                            <div class="summary-row">
