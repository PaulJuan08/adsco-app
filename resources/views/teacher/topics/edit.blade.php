        ...
        <div class="card-body">
                ...
                <div class="publish-info-content">
                    ...
                    <div class="publish-info-value">
                        ...
                        @else
                            ...
                            <span style="font-size: 0.75rem; color: #718096;">Only visible to instructors and teachers</span>
                        @endif
                    </div>
                </div>
            </div>
            ...
            <div class="two-column-layout">
                ...
                <div class="form-column">
                    <!-- Update Form -->
                    <form action="{{ route('teacher.topics.update', Crypt::encrypt($topic->id)) }}" method="POST" enctype="multipart/form-data" id="topicForm">
                        @csrf
                        @method('PUT')
            ...
            <div class="form-actions" style="margin-top: 1.5rem;">
                ...
                <div style="display: flex; gap: 0.75rem;">
                    <a href="{{ route('teacher.topics.index') }}" class="btn btn-outline">
