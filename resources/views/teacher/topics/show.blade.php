    ...
    <div class="card" style="margin-bottom: 1.5rem;">
        ...
        <div style="padding: 1.5rem;">
            ...
            <div style="margin-bottom: 1.5rem;">
                ...
                <div style="padding: 1rem; background: #f8fafc; border-radius: 8px; border: 1px solid var(--border);">
                    @php
                        // Helper functions for file icons (you can copy these from admin TopicController or create a helper)
                        ...
                        $color = getFileColor($topic->attachment);
                        $type = getFileType($topic->attachment);
                    @endphp
    ...
    <div class="card">
        ...
        <div style="padding: 1.5rem;">
            <div style="display: flex; flex-direction: column; gap: 1rem;">
                ...
                <form action="{{ route('teacher.topics.destroy', Crypt::encrypt($topic->id)) }}" method="POST" style="display: block;">
                    @csrf
                    @method('DELETE')
                    <button type="submit" 
