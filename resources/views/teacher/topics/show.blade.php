            ...
            <div class="two-column-layout">
                ...
                <div class="sidebar-column">
                            ...
                            @if($courseCount > 0)
                                <div style="display:flex;flex-wrap:wrap;gap:.4rem;">
                                    @foreach($topic->courses as $course)
                                        <a href="{{ route('teacher.courses.show', Crypt::encrypt($course->id)) }}" class="course-tag">
                                            {{ $course->course_code }}
                                        </a>
                                    @endforeach
                                </div>
                    ...
                    <div class="sidebar-card">
                        ...
                        <button onclick="openCrudModal('{{ route('teacher.topics.edit', $encryptedId) }}', 'Edit Topic')" class="quick-action-link" style="border:none;cursor:pointer;width:100%;background:transparent;">
