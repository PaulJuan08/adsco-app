    ...
    <div class="dashboard-header">
        <div class="header-content">
            ...
            <div class="header-actions">
                <a href="{{ route('teacher.topics.create') }}" class="top-action-btn">
            ...
            @else
                <div class="topics-card-grid" id="topics-table">
                    ...
                    <div class="topic-card-item"
                        ...
                        {{-- Thumbnail --}}
                        <a href="{{ $encryptedId ? route('teacher.topics.show', ['encryptedId' => $encryptedId]) : '#' }}" class="topic-card-thumb" style="display:block;">
                            @if($youtubeThumbnail)
                        ...
                        <div class="topic-card-footer">
                            ...
                            <div class="topic-card-actions">
                                @if($encryptedId)
                                    <a href="{{ route('teacher.topics.edit', ['encryptedId' => $encryptedId]) }}" class="btn-card-action btn-card-edit" title="Edit"><i class="fas fa-pencil-alt"></i></a>
                                    <a href="{{ route('teacher.topics.show', ['encryptedId' => $encryptedId]) }}" class="btn-card-action btn-card-view" title="View"><i class="fas fa-eye"></i></a>
                                @endif
                            </div>
                        </div>
                    </div>
