...
<div class="dashboard-container">
            ...
            <div class="user-greeting">
                ...
                <div class="greeting-text">
                    ...
                    <p class="welcome-subtitle">
                        <i class="fas fa-chalkboard"></i> Manage learning topics for your courses
    ...
    <div class="stats-grid stats-grid-compact">
        ...
        <a href="{{ route('teacher.topics.index') }}?has_video=true" class="stat-card stat-card-warning clickable-card">
            <div class="stat-header">
                <div>
        ...
        <a href="{{ route('teacher.topics.index') }}?status=draft" class="stat-card stat-card-info clickable-card">
            <div class="stat-header">
                <div>
    ...
    <div class="dashboard-card">
        <div class="card-header">
            ...
            <div class="header-actions-bar">
                ...
                <button onclick="openCrudModal('{{ route('teacher.topics.create') }}', 'Add Topic')" class="btn btn-primary">
            ...
            @if($topics->isEmpty())
                <div class="empty-state">
                    ...
                    <div class="empty-hint">
                        <i class="fas fa-lightbulb"></i> Topics are learning units that can contain videos and materials
                    </div>
                </div>
            @else
                <div class="topics-card-grid" id="topics-table">
                    ...
                    <div class="topic-card-item"
                        ...
                        {{-- Thumbnail --}}
                        <div onclick="{{ $encryptedId ? "openCrudModal('".route('teacher.topics.show', ['encryptedId' => $encryptedId])."', '{$topic->title}', '940px')" : '' }}" class="topic-card-thumb" style="display:block;cursor:pointer;">
                            @if($youtubeThumbnail)
                        ...
                        <div class="card-footer-actions">
                            <form method="POST" action="{{ route('teacher.topics.publish', $encryptedId) }}" style="margin:0;">
                                @csrf @method('PATCH')
                            ...
                            <div class="action-dropdown-wrapper">
                                ...
                                <div class="action-dropdown-menu">
                                    <a href="{{ route('teacher.topics.show', ['encryptedId' => $encryptedId]) }}" class="dropdown-item">
                                        <i class="fas fa-eye"></i> View
                                    </a>
                                    <button onclick="openCrudModal('{{ route('teacher.topics.edit', ['encryptedId' => $encryptedId]) }}', 'Edit Topic')" class="dropdown-item">
    ...
    <div id="print-content" style="display: none;">
        <div style="padding: 20px; font-family: Arial, sans-serif;">
            <div style="text-align: center; margin-bottom: 20px;">
                <h1 style="color: #4f46e5;">Topic Management Report</h1>
...
function confirmDeleteItem(encId, title) {
    Swal.fire({
        ...
        if (r.isConfirmed) {
            ...
            f.action = '{{ url("teacher/topics") }}/' + encId;
            f.submit();
        }
    });
}
