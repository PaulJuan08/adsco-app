    ...
    <div class="dashboard-card">
        <div class="card-header">
            ...
            <div class="header-actions-bar">
                ...
                <button onclick="openCrudModal('{{ route('teacher.courses.create') }}', 'Add Course')" class="btn btn-primary">
                                ...
                                <td class="action-col" onclick="event.stopPropagation()">
                                    ...
                                    <div class="action-dropdown-wrapper">
                                        ...
                                        <div class="action-dropdown-menu">
                                            <a href="{{ route('teacher.courses.show', ['encryptedId' => $encryptedId]) }}" class="dropdown-item">
                                                <i class="fas fa-eye"></i> View
                                            </a>
                                            <button onclick="openCrudModal('{{ route('teacher.courses.edit', $encryptedId) }}', 'Edit Course')" class="dropdown-item">
                                                <i class="fas fa-edit"></i> Edit
                                            </button>
                                            <form method="POST" action="{{ route('teacher.courses.publish', $encryptedId) }}" style="margin:0;">
                                                @csrf @method('PATCH')
    ...
    window.confirmDeleteItem = function(encId, name) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                form.action = `{{ url('teacher/courses') }}/${encId}`;
                form.submit();
            }
        });
    };
