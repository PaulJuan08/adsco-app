            ...
            <div class="two-column-layout">
                ...
                <div class="sidebar-column">
                    ...
                    <div class="sidebar-card">
                        ...
                        <a href="{{ route('teacher.courses.edit', $encryptedId) }}" class="quick-action-link">
...
function renderAvailableTopics(topics) {
    ...
    if (!Array.isArray(topics) || topics.length === 0) {
        container.innerHTML = `
            ...
            <a href="{{ route('teacher.topics.create') }}" class="btn-sm btn-sm-primary" style="margin-top:1rem;">
