    ...
    <div class="row">
        <div class="col-12">
            <div class="page-header">
                ...
                <a href="{{ route('teacher.profile.show') }}" class="btn-outline-primary">
        ...
        <div class="col-lg-8 mx-auto">
            ...
            <div class="form-container">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('teacher.profile.update') }}" method="POST" id="profileForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-grid" style="margin-top: 1rem;">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="Teacher" readonly disabled>
                                </div>
                        ...
                        <div class="form-actions">
                            <a href="{{ route('teacher.profile.show') }}" class="btn btn-light">
