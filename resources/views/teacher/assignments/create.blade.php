...
<div class="form-container">
    ...
    <div class="card-header">
        ...
        <a href="{{ route('teacher.assignments.index') }}" class="view-all-link">
    ...
    <form method="POST" action="{{ route('teacher.assignments.store') }}">
        ...
        <div class="card-footer-modern">
            <button type="button" onclick="window.location.href='{{ route('teacher.assignments.index') }}'" class="btn btn-secondary">
