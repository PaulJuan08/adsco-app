            ...
            <div class="two-column-layout">
                ...
                <div class="sidebar-column">
                    ...
                    <div class="sidebar-card">
                        ...
                        <a href="{{ route('admin.topics.index') }}" class="quick-action-link">
...
<form id="publish-form" method="POST" action="{{ route('admin.topics.publish', $encryptedId) }}" style="display:none;">
    @csrf @method('PATCH')
</form>
<form id="delete-form" method="POST" action="{{ route('admin.topics.destroy', $encryptedId) }}" style="display:none;">
    @csrf @method('DELETE')
</form>
@endsection
...
// ════════════════════════════════════════════════════════════════
const ROUTES = {
    publishTopic: '{{ route("admin.topics.publish", $encryptedId) }}',
    deleteTopic: '{{ route("admin.topics.destroy", $encryptedId) }}',
};
