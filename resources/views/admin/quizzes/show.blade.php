...
<div class="card">
    ...
    <div style="padding: 2rem;">
        ...
        <form action="{{ url('/admin/quizzes/' . Crypt::encrypt($quiz->id) . '/submit') }}" method="POST" id="quiz-form">
            @csrf
...
<script>
    ...
    function closeModal() {
        ...
        if (modal) {
            ...
            window.location.href = "{{ route('admin.quizzes.show', Crypt::encrypt($quiz->id)) }}";
        }
    }
