...
<style>
    /* Additional styles for access management - matching quiz access pattern */
    :root {
        --primary: #f59e0b;
        --primary-dark: #d97706;
    ...
    /* Assignment Info Bar - matching quiz-info-bar */
    .assignment-info-bar {
    ...
    /* Access Layout - matching quiz access */
    .access-layout {
        display: grid;
    ...
    /* Filter Bar - matching quiz access */
    .filter-bar {
        background: white;
        border-radius: 16px;
        padding: 1.5rem;
    ...
    /* Button styles matching quiz access */
    .btn-sm {
        padding: 0.5rem 1rem;
        font-size: 0.75rem;
        font-weight: 600;
    ...
    /* Student Table - matching quiz access */
    .student-table-wrap {
        background: white;
        border-radius: 16px;
        border: 1px solid #e2e8f0;
    ...
    /* Status Badge - matching quiz access */
    .status-badge {
        display: inline-flex;
        align-items: center;
        gap: 0.375rem;
    ...
    /* Toggle Switch - matching quiz access */
    .access-toggle {
        position: relative;
    ...
    /* Pagination Row - matching quiz access */
    .pagination-row {
        display: flex;
    ...
    /* Sidebar Card - matching quiz access */
    .sidebar-card {
        background: white;
        border-radius: 16px;
        padding: 1.5rem;
    ...
    /* Quick Action Links - matching quiz access */
    .quick-action-link {
        display: flex;
        align-items: center;
        gap: 0.75rem;
    ...
    /* Help Card - matching quiz access */
    .help-card {
        background: linear-gradient(135deg, #f7fafc 0%, #edf2f7 100%);
    }
    ...
    <div class="form-container">
        ...
        <div class="card-header">
            ...
            <div class="top-actions">
                ...
                <a href="{{ route('admin.assignments.show', $encryptedId) }}" class="top-action-btn">
        ...
        <div class="access-layout">
            ...
            <div>
                {{-- Filter Bar --}}
                <form method="GET" action="{{ route('admin.todo.assignment.access', $encryptedId) }}" class="filter-bar">
                    <div class="filter-row">
                        ...
                        <a href="{{ route('admin.todo.assignment.access', $encryptedId) }}" 
            ...
            <div>
                        ...
                        <span class="val">
                            @if($assignment->creator)
                                ...
                                <span style="display: block; font-size: 0.7rem; color: #718096;">
                                    ({{ $assignment->creator->role == 1 ? 'Admin' : ($assignment->creator->role == 3 ? 'Teacher' : 'User') }})
                                </span>
                            @else
                ...
                <div class="sidebar-card">
                    ...
                    <a href="{{ route('admin.assignments.edit', $encryptedId) }}" class="quick-action-link">
                    ...
                    <a href="{{ route('admin.assignments.show', $encryptedId) }}" class="quick-action-link">
                        <i class="fas fa-eye"></i>
                        <span>View Assignment</span>
                    </a>
                    
                    <a href="{{ route('admin.assignments.index') }}" class="quick-action-link">
...
{{-- Hidden Forms --}}
<form id="grant-form" method="POST" action="{{ route('admin.todo.assignment.grant', $encryptedId) }}" style="display: none;">
    @csrf
    <input type="hidden" name="student_ids" id="grant-student-ids">
</form>

<form id="revoke-form" method="POST" action="{{ route('admin.todo.assignment.revoke', $encryptedId) }}" style="display: none;">
    @csrf
