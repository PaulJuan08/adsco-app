            ...
            <div class="two-column-layout">
                ...
                <div class="form-column">
                    ...
                    <div class="detail-section">
                        ...
                        <div class="empty-state">
                            ...
                            <button onclick="openCrudModal('{{ route('admin.quizzes.edit', $encryptedId) }}', 'Edit Quiz')" class="btn-sm btn-sm-primary" style="border:none;cursor:pointer;">
                    ...
                    <div class="detail-section">
                        ...
                        <div style="text-align: center; margin-top: 1rem;">
                            <a href="{{ route('admin.todo.progress', ['type' => 'quiz', 'item_id' => $quiz->id]) }}" class="btn-sm btn-sm-primary">
                ...
                <div class="sidebar-column">
                    ...
                    <div class="sidebar-card">
                        ...
                        <button onclick="openCrudModal('{{ route('admin.quizzes.edit', $encryptedId) }}', 'Edit Quiz')" class="quick-action-link" style="border:none;cursor:pointer;width:100%;background:transparent;">
