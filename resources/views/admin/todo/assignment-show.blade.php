            ...
            <div class="two-column-layout">
                                            ...
                                            <div>
                                                ...
                                                <div class="submission-meta">
                                                    <span><i class="fas fa-id-card"></i> 
                                                        ...
                                                        @else
                                                            <span style="color: #f56565;">Account Deleted</span>
                                                        @endif
                                                    </span>
                ...
                <div class="sidebar-column">
                    ...
                    <div class="sidebar-card">
                        ...
                        <button onclick="openAccessModal()" class="quick-action-link" style="width: 100%; border: none; cursor: pointer;">
                    ...
                    <div class="sidebar-card help-card">
                        ...
                        <div class="help-text">
                            <p style="margin-bottom: 0.75rem;">
                                <strong>Grant Access:</strong> Click the "Grant Access" button to manage which students can submit this assignment.
                            </p>
                            <p style="margin-bottom: 0.75rem;">
                                <strong>Publishing:</strong> Students can only see published assignments they have access to.
                            </p>
                            <p>
...
{{-- Hidden Forms --}}
<form id="publish-form" method="POST" action="{{ route('admin.assignments.publish', $encryptedId) }}" style="display: none;">
    @csrf
    @method('PATCH')
</form>
