                ...
                <tr>
                        ...
                        <div class="student-cell">
                            @if($submission->student)
                                ...
                                <div class="student-info">
                                    <div class="student-name">{{ $submission->student->full_name ?? 'Unknown' }}</div>
                    ...
                    <td>
                        @if($submission->assignment)
                            <div class="fw-600">{{ Str::limit($submission->assignment->title, 40) }}</div>
                        ...
                        @else
                            <div class="fw-600 text-danger"><i class="fas fa-exclamation-triangle"></i> Deleted Assignment</div>
                        @endif
                    </td>
                        ...
                        <div class="action-group">
                            ...
                            @if($submission->assignment && $submission->assignment->id)
                                <a href="{{ route('admin.todo.assignment.show', Crypt::encrypt($submission->assignment->id)) }}"
                                   class="view-btn" title="View Assignment">
                                    <i class="fas fa-eye"></i>
                                </a>
                            @endif
                            @if($status !== 'graded' && $submission->assignment && $submission->assignment->id)
