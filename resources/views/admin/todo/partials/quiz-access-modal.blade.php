<div class="access-modal-container">
    {{-- Filter Bar --}}
    <form method="GET" action="{{ route('admin.todo.quiz.access.modal', $encryptedId) }}" class="filter-bar" id="modal-filter-form">
        <div class="filter-row">
            ...
            <a href="{{ route('admin.todo.quiz.access.modal', $encryptedId) }}" 
