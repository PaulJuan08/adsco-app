    ...
    <div class="form-container">
        ...
        <div class="card-header">
            ...
            <div class="top-actions">
                ...
                <a href="{{ route('admin.todo.index') }}" class="top-action-btn">
        ...
        <div class="access-layout">
            ...
            <div>
                {{-- Filter Bar --}}
                <form method="GET" action="{{ route('admin.todo.quiz.access', $encryptedId) }}" class="filter-bar">
                    <div class="filter-row">
                        ...
                        <a href="{{ route('admin.todo.quiz.access', $encryptedId) }}" 
                ...
                <form method="POST" id="bulk-form">
                    ...
                    <div class="student-table-wrap">
                        <div class="bulk-bar">
                            ...
                            <button type="submit" 
                                    formaction="{{ route('admin.todo.quiz.grant', $encryptedId) }}" 
                                    class="btn-sm btn-sm-success">
                                <i class="fas fa-check-circle"></i> Grant Selected
                            </button>
                            
                            <button type="submit" 
                                    formaction="{{ route('admin.todo.quiz.revoke', $encryptedId) }}" 
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center;">
                                        <label class="access-toggle">
                                            <input type="checkbox"
                                                   class="toggle-access"
                                                   data-url="{{ route('admin.todo.quiz.toggle', [$encryptedId, $student->id]) }}"
            ...
            <div>
                ...
                <div class="sidebar-card">
                    ...
                    <a href="{{ route('admin.quizzes.show', $encryptedId) }}" class="quick-action-link">
                        <i class="fas fa-eye"></i>
                        <span>Preview Quiz</span>
                    </a>
                    
                    <a href="{{ route('admin.todo.index') }}" class="quick-action-link">
