                            ...
                            <table class="courses-table" id="courses-table">
                                ...
                                <tbody>
                                    ...
                                    <tr class="clickable-row" 
                                        data-href="{{ route('admin.courses.show', urlencode(Crypt::encrypt($course->id))) }}"
            ...
            <div class="dashboard-card">
                ...
                <div class="card-body">
                    <div class="items-list">
                        <a href="{{ route('admin.courses.index') }}?month={{ now()->format('Y-m') }}" class="list-item clickable-item">
                            ...
                            <div class="stat-number" style="font-size: 1.5rem;">{{ $coursesThisMonth }}</div>
                        </a>
                        ...
                        <div class="list-item">
                            ...
                            <div class="stat-number" style="font-size: 1.5rem;">{{ $avgStudents }}</div>
                        </div>
                        
                        <a href="{{ route('admin.courses.index') }}?status=published" class="list-item clickable-item">
                            ...
                            <div class="stat-number" style="font-size: 1.5rem;">{{ $activeCourses }}</div>
                        </a>
                        
                        <a href="{{ route('admin.courses.index') }}?has_teacher=true" class="list-item clickable-item">
                            <div class="item-avatar" style="border-radius: var(--radius); background: linear-gradient(135deg, var(--info-light), var(--info));">
                                <i class="fas fa-user-tie"></i>
                            </div>
                            <div class="item-info">
                                <div class="item-name">Courses with Teacher</div>
                            </div>
                            <div class="stat-number" style="font-size: 1.5rem;">{{ $assignedTeachers }}</div>
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div style="margin-bottom: 30px;">
                ...
                <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 15px; margin-bottom: 20px;">
                    ...
                    <div style="background: #fef3c7; padding: 15px; border-radius: 8px; border: 1px solid #fde68a;">
                        <div style="font-size: 24px; font-weight: bold; color: #d97706; margin-bottom: 5px;">{{ $activeCourses ?? 0 }}</div>
                    ...
                    <div style="background: #dcfce7; padding: 15px; border-radius: 8px; border: 1px solid #bbf7d0;">
                        ...
                        <div style="font-size: 14px; color: #059669;">Courses with Teachers</div>
                    </div>
...
@push('styles')
<style>
    /* Additional styles specific to courses index */
    .header-actions {
        display: flex;
        gap: 1rem;
        align-items: center;
            ...
            table.querySelectorAll('tbody tr').forEach(row => {
                ...
                if (columns[2]) {
                    ...
                    if (teacherInfo) {
                        ...
                        const noTeacher = columns[2].querySelector('.no-teacher');
                        if (noTeacher) {
                            teacherName = noTeacher.textContent.trim();
                        }
                    }
                } else {
