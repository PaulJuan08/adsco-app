    ...
    <div class="layout-with-sidebar">
        ...
        <aside class="sidebar">
            <div class="sidebar-header">
                ...
                <div class="sidebar-title">REGISTRAR</div>
            </div>
            ...
            <nav class="sidebar-nav">
                ...
                <a href="{{ route('registrar.users.index') }}" class="sidebar-nav-item {{ request()->routeIs('registrar.users.*') ? 'active' : '' }}">
            ...
            <div class="sidebar-footer">
                <div class="sidebar-user-profile">
                    <div class="sidebar-user-avatar">
                        {{ strtoupper(substr(Auth::user()->f_name ?? 'R', 0, 1)) }}
                    </div>
