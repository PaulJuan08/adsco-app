    ...
    <div class="dashboard-container">
        ...
        <aside class="sidebar">
            <div class="sidebar-header">
                ...
                <div class="logo-text">REGISTRAR</div>
            </div>
            ...
            <nav class="sidebar-nav">
                ...
                <a href="{{ route('registrar.users.index') }}" class="nav-item {{ request()->routeIs('registrar.users.*') ? 'active' : '' }}">
                    <i class="fas fa-users"></i>
                    <span>Users</span>
                </a>
                <!-- Registrar cannot manage courses, attendance, or audit logs -->
