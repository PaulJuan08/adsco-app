    ...
    <div class="row">
        <div class="col-12">
            <div class="page-header">
                ...
                <a href="{{ route('student.profile.show') }}" class="btn-outline-primary">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('student.profile.update') }}" method="POST" id="profileForm">
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-grid" style="margin-top: 1rem;">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="Student" readonly disabled>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{ $user->student_id ?? 'Not assigned' }}" readonly disabled>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-grid">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{ $user->college->college_name ?? 'Not assigned' }}" readonly disabled>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{ $user->program->program_name ?? 'Not assigned' }}" readonly disabled>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="{{ $user->college_year ?? 'Not assigned' }}" readonly disabled>
                                </div>
                            </div>
                            
                            <div class="form-text" style="margin-top: 0.5rem;">
                                <i class="fas fa-info-circle"></i> Academic information can only be updated by your registrar or admin.
                            </div>
                        </div>
                        ...
                        <div class="form-actions">
                            <a href="{{ route('student.profile.show') }}" class="btn btn-light">
